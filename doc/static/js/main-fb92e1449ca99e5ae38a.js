...
var _moarwick$elm_webpack_starter$Components_App_Constants$Annotator = F2(
	function (a, b) {
		return {ctor: 'Annotator', _0: a, _1: b};
	});
var _moarwick$elm_webpack_starter$Components_App_Constants$annotators = {
	ctor: '::',
	_0: A2(_moarwick$elm_webpack_starter$Components_App_Constants$Annotator, 'sample', 'Sample'),
	_1: {
		ctor: '::',
		_0: A2(_moarwick$elm_webpack_starter$Components_App_Constants$Annotator, 'soundth', 'Sound \"th\"'),
		_1: {
			ctor: '::',
			_0: A2(_moarwick$elm_webpack_starter$Components_App_Constants$Annotator, 'sounded', 'Sound \"ed\"'),
			_1: {
				ctor: '::',
				_0: A2(_moarwick$elm_webpack_starter$Components_App_Constants$Annotator, 'link2', 'Link 2'),
				_1: {
					ctor: '::',
					_0: A2(_moarwick$elm_webpack_starter$Components_App_Constants$Annotator, 'contentword', 'ContentWord'),
					_1: {
						ctor: '::',
						_0: A2(_moarwick$elm_webpack_starter$Components_App_Constants$Annotator, 'intonationfinal', 'Intonation-final'),
						_1: {
							ctor: '::',
							_0: A2(_moarwick$elm_webpack_starter$Components_App_Constants$Annotator, 'pausing', 'Pausing'),
							_1: {
								ctor: '::',
								_0: A2(_moarwick$elm_webpack_starter$Components_App_Constants$Annotator, 'sounds', 'Sound \"s\"'),
								_1: {ctor: '[]'}
							}
						}
					}
		...
		return A2(
			_elm_lang$html$Html$button,
			{
				...
				_0: _elm_lang$html$Html_Events$onClick(
					_moarwick$elm_webpack_starter$Components_App_Msg$ApplyAnnotation(_p1._0)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _moarwick$elm_webpack_starter$Components_App_Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'ApplyAnnotation') {
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				model,
				{
					ctor: '::',
					_0: _moarwick$elm_webpack_starter$Components_App_Ports$applyAnnotation(_p0._0),
					_1: {ctor: '[]'}
				});
		} else {
			return A2(
...
var _moarwick$elm_webpack_starter$Components_App_View$viewResultArea = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('resultArea'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
...
var _moarwick$elm_webpack_starter$Components_App_View$viewInputArea = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('inputArea'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
...
var _moarwick$elm_webpack_starter$Components_App_View$viewAnnotatorButtons = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('annotatorButtons'),
			_1: {ctor: '[]'}
		},
		A2(
			_elm_lang$core$List$map,
			A2(_elm_lang$core$Basics$flip, _moarwick$elm_webpack_starter$Components_App_AnnotatorToggleView$annotatorToggle, model),
			_moarwick$elm_webpack_starter$Components_App_Constants$annotators));
};
...
var $ = jQuery = __webpack_require__(3);           // <--- remove if jQuery not needed
__webpack_require__(0);   // <--- remove if Bootstrap's JS not needed 

// annotators
var annotators = __webpack_require__(4);
