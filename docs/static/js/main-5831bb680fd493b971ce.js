...
var _moarwick$elm_webpack_starter$Components_App_Annotator$defaultAnnotator = {id: 'default', name: ''};
var _moarwick$elm_webpack_starter$Components_App_Annotator$find = function (id) {
	return function (_p0) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			_moarwick$elm_webpack_starter$Components_App_Annotator$defaultAnnotator,
			A2(
...
var _moarwick$elm_webpack_starter$Components_App_Annotator$make = F2(
	function (id, name) {
		return {id: id, name: name};
	});
var _moarwick$elm_webpack_starter$Components_App_Annotator$annotators = {
	ctor: '::',
	_0: A2(_moarwick$elm_webpack_starter$Components_App_Annotator$make, 'sample', 'Sample'),
	_1: {
		ctor: '::',
		_0: A2(_moarwick$elm_webpack_starter$Components_App_Annotator$make, 'soundth', 'Sound \"th\"'),
		_1: {
			ctor: '::',
			_0: A2(_moarwick$elm_webpack_starter$Components_App_Annotator$make, 'sounded', 'Sound \"ed\"'),
			_1: {
				ctor: '::',
				_0: A2(_moarwick$elm_webpack_starter$Components_App_Annotator$make, 'link2', 'Link 2'),
				_1: {
					ctor: '::',
					_0: A2(_moarwick$elm_webpack_starter$Components_App_Annotator$make, 'contentword', 'ContentWord'),
					_1: {
						ctor: '::',
						_0: A2(_moarwick$elm_webpack_starter$Components_App_Annotator$make, 'intonationfinal', 'Intonation-final'),
						_1: {
							ctor: '::',
							_0: A2(_moarwick$elm_webpack_starter$Components_App_Annotator$make, 'pausing', 'Pausing'),
							_1: {
								ctor: '::',
								_0: A2(_moarwick$elm_webpack_starter$Components_App_Annotator$make, 'sounds', 'Sound \"s\"'),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _moarwick$elm_webpack_starter$Components_App_Annotator$Annotator = F2(
	function (a, b) {
		return {id: a, name: b};
	});

var _moarwick$elm_webpack_starter$Components_App_Model$isEnabledAnnotatorId = F2(
	function (id, model) {
		return A2(
			_elm_lang$core$List$any,
			F2(
...
var _moarwick$elm_webpack_starter$Components_App_Model$initialModel = {
	enabledAnnotatorIds: {ctor: '[]'}
};
var _moarwick$elm_webpack_starter$Components_App_Model$Model = function (a) {
	return {enabledAnnotatorIds: a};
};

var _moarwick$elm_webpack_starter$Components_App_Msg$NoOp = {ctor: 'NoOp'};
var _moarwick$elm_webpack_starter$Components_App_Msg$AppliedMultiAnnotations = function (a) {
	return {ctor: 'AppliedMultiAnnotations', _0: a};
};
var _moarwick$elm_webpack_starter$Components_App_Msg$ApplyMultiAnnotations = {ctor: 'ApplyMultiAnnotations'};
var _moarwick$elm_webpack_starter$Components_App_Msg$AppliedAnnotation = function (a) {
	return {ctor: 'AppliedAnnotation', _0: a};
};
var _moarwick$elm_webpack_starter$Components_App_Msg$ApplyAnnotation = function (a) {
	return {ctor: 'ApplyAnnotation', _0: a};
};

var _moarwick$elm_webpack_starter$Components_App_AnnotatorToggleView$annotatorToggle = F2(
	function (annotator, model) {
		var toggleCls = A2(_moarwick$elm_webpack_starter$Components_App_Model$isEnabledAnnotatorId, annotator.id, model) ? 'annotator-toggle-on' : 'annotator-toggle-off';
		return A2(
			_elm_lang$html$Html$button,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(
					A2(_elm_lang$core$Basics_ops['++'], 'annotator-toggle ', toggleCls)),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_moarwick$elm_webpack_starter$Components_App_Msg$ApplyAnnotation(annotator.id)),
					_1: {ctor: '[]'}
				}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(annotator.name),
				_1: {ctor: '[]'}
			});
	});

var _moarwick$elm_webpack_starter$Components_App_Constants$viewPhrases = {pageTitle: 'Script annotator (2017 E317 patterns and language)'};
var _moarwick$elm_webpack_starter$Components_App_Constants$ViewPhrases = function (a) {
	return {pageTitle: a};
};

var _moarwick$elm_webpack_starter$Components_App_Ports$applyAnnotation = _elm_lang$core$Native_Platform.outgoingPort(
	'applyAnnotation',
	function (v) {
		return v;
	});
var _moarwick$elm_webpack_starter$Components_App_Ports$appliedAnnotation = _elm_lang$core$Native_Platform.incomingPort(
	'appliedAnnotation',
	_elm_lang$core$Json_Decode$null(
		{ctor: '_Tuple0'}));
var _moarwick$elm_webpack_starter$Components_App_Ports$applyMultiAnnotations = _elm_lang$core$Native_Platform.outgoingPort(
...
var _moarwick$elm_webpack_starter$Components_App_Ports$appliedMultiAnnotations = _elm_lang$core$Native_Platform.incomingPort(
	'appliedMultiAnnotations',
	_elm_lang$core$Json_Decode$null(
		{ctor: '_Tuple0'}));
var _moarwick$elm_webpack_starter$Components_App_Ports$subscriptions = _elm_lang$core$Platform_Sub$batch(
	{
		ctor: '::',
		_0: _moarwick$elm_webpack_starter$Components_App_Ports$appliedAnnotation(_moarwick$elm_webpack_starter$Components_App_Msg$AppliedAnnotation),
		_1: {
			ctor: '::',
			_0: _moarwick$elm_webpack_starter$Components_App_Ports$appliedMultiAnnotations(_moarwick$elm_webpack_starter$Components_App_Msg$AppliedMultiAnnotations),
			_1: {ctor: '[]'}
		}
	});

var _moarwick$elm_webpack_starter$Components_App_Update$toggleAnnotator = F2(
	function (id, model) {
		var beDisable = A2(
			_elm_lang$core$List$filter,
			F2(
			...
			model.enabledAnnotatorIds);
		var beEnable = _elm_community$list_extra$List_Extra$unique(
			{ctor: '::', _0: id, _1: model.enabledAnnotatorIds});
		var isEnabled = A2(_moarwick$elm_webpack_starter$Components_App_Model$isEnabledAnnotatorId, id, model);
		return isEnabled ? beDisable : beEnable;
	});
var _moarwick$elm_webpack_starter$Components_App_Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'ApplyAnnotation':
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							enabledAnnotatorIds: A2(_moarwick$elm_webpack_starter$Components_App_Update$toggleAnnotator, _p1, model)
						}),
					{
						ctor: '::',
						_0: _moarwick$elm_webpack_starter$Components_App_Ports$applyAnnotation(_p1),
						_1: {ctor: '[]'}
					});
			case 'ApplyMultiAnnotations':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					{
						ctor: '::',
						_0: _moarwick$elm_webpack_starter$Components_App_Ports$applyMultiAnnotations(model.enabledAnnotatorIds),
						_1: {ctor: '[]'}
					});
			default:
				return A2(
...
var _moarwick$elm_webpack_starter$Components_App_View$viewResultArea = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('result-area'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
...
var _moarwick$elm_webpack_starter$Components_App_View$viewInputArea = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('input-area'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
...
var _moarwick$elm_webpack_starter$Components_App_View$viewRunButton = function (model) {
	return A2(
		_elm_lang$html$Html$button,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(_moarwick$elm_webpack_starter$Components_App_Msg$ApplyMultiAnnotations),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _moarwick$elm_webpack_starter$Components_App_View$viewAnnotatorButtons = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('annotator-buttons'),
			_1: {ctor: '[]'}
		},
		A2(
			_elm_lang$core$List$map,
			A2(_elm_lang$core$Basics$flip, _moarwick$elm_webpack_starter$Components_App_AnnotatorToggleView$annotatorToggle, model),
			_moarwick$elm_webpack_starter$Components_App_Annotator$annotators));
};
var _moarwick$elm_webpack_starter$Components_App_View$viewPageTitle = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text(_moarwick$elm_webpack_starter$Components_App_Constants$viewPhrases.pageTitle),
		_1: {ctor: '[]'}
	});
var _moarwick$elm_webpack_starter$Components_App_View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('main-frame'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _moarwick$elm_webpack_starter$Components_App_View$viewPageTitle,
			_1: {
				ctor: '::',
				_0: _moarwick$elm_webpack_starter$Components_App_View$viewAnnotatorButtons(model),
				_1: {
					ctor: '::',
					_0: _moarwick$elm_webpack_starter$Components_App_View$viewRunButton(model),
					_1: {
						ctor: '::',
						_0: _moarwick$elm_webpack_starter$Components_App_View$viewInputArea,
						_1: {
							ctor: '::',
							_0: _moarwick$elm_webpack_starter$Components_App_View$viewResultArea,
							_1: {ctor: '[]'}
						}
					}
				}
...
var _moarwick$elm_webpack_starter$Main$main = _elm_lang$html$Html$program(
	{
		init: A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			_moarwick$elm_webpack_starter$Components_App_Model$initialModel,
			{ctor: '[]'}),
		view: _moarwick$elm_webpack_starter$Components_App_View$view,
		update: _moarwick$elm_webpack_starter$Components_App_Update$update,
		subscriptions: function (_p0) {
			return _moarwick$elm_webpack_starter$Components_App_Ports$subscriptions;
		}
	})();
...
// group 9
var runner = __webpack_require__(0);
...
var $ = jQuery = __webpack_require__(4);           // <--- remove if jQuery not needed
__webpack_require__(1);   // <--- remove if Bootstrap's JS not needed 

// annotators
var annotators = __webpack_require__(5);
var runner = __webpack_require__(0);
