...
b[10] = /(([\s]*[A-Za-z]*)(phs)([\s.,\!\?\:\;]))/gi;

b[11] = /(([\s]*[A-Za-z]*)('s)([\s.,\!\?\:\;]))/gi; 
b[12] = /(([\s]*[A-Za-z]*)(`s)([\s.,\!\?\:\;]))/gi;
b[13] = /(([\s]*[A-Za-z]*)(ous)([\s.,\!\?\:\;]))/gi;

b[14] = /(([\s]*)(yes)([\s.,\!\?\:\;]))/gi; 
b[15] = /(([\s]*[Oo]*[asi])(s)([\s.,\!\?\:\;]))/gi; 
b[16] = /(([\s]*)(asher)([\s.,\!\?\:\;]))/gi; 

b[17] = /(([\s]*[A-Za-z]*[a i u e o b d g j l m n r v y w])(s)([\s.,\!\?\:\;]))/gi;
b[18] = /(([\s]*[A-Za-z]*[f p t k c s])(s)([\s.,\!\?\:\;]))/gi;
